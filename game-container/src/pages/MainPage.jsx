...
function MainPage() {
    ...
    return (
        <div className = "min-h-screen bg-[#000000]/75">
            {/* Top Navigation Bar */}
                ...
                <div className="flex items-center">
                    ...
                    <div className="flex-1 flex justify-center px-4">
                        <input
                            ...
                            className="w-full max-w-md px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 hover:bg-gray-400 hover:placeholder: text-white transition"
                        />
                    </div>
                    ...
                    <div className="flex-1 flex justify-end">
                        <div className="flex space-x-4">
                            <button
                                className="px-5 py-2 bg-white text-gray-800 rounded-x1 text-base font-medium hover:bg-gray-400 transition"
                                onClick={goToLogin}
                            >
                                Login
                            </button>
